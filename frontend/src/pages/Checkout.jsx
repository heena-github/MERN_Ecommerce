...
const Checkout = () => {
  ...
  return (
    ...
    <div className="space-y-12">
     ...
     <div className="mx-auto max-w-7xl bg-white mt-12 px-2 sm:px-2 lg:px-6">
        ...
        <h2 className='text-4xl my-12 font-bold tracking-tight text-gray-900'>Cart</h2>
                              ...
                              <li key={product.id} className="flex py-6">
                                ...
                                <div className="ml-4 flex flex-1 flex-col">
                                  <div>
                                    ...
                                    <p className="mt-1 mb-2 text-sm text-gray-500">{product.brand}</p>
                                  </div>
                                  <div className="flex flex-1 items-end justify-between text-sm items-center">
                                    ...
                                    <select onChange={(e)=>handleQuantity(e,product)} value={items.quantity}>
                    ...
                    <div className="border-t border-gray-200 px-3 py-6 sm:px-2">
